...
while (i := i + 1) < iterlim and potential_current > tol:
    ...
    p1_grad = ho.gradient_wrt_ri(p1, p2) + hoo.gradient_wrt_ri(p1, p2, p3) + hh.gradient_wrt_ri(p1, p4) + hooh.gradient_wrt_ri(p1, p2, p3, p4)
    p2_grad = ho.gradient_wrt_rj(p1, p2) + oo.gradient_wrt_ri(p2, p3) + hoo.gradient_wrt_rj(p1, p2,p3) + hoo.gradient_wrt_ri(p2, p3, p4) + hooh.gradient_wrt_rj(p1, p2, p3, p4)
    p3_grad = oo.gradient_wrt_rj(p2, p3) + ho.gradient_wrt_ri(p3, p4) + hoo.gradient_wrt_rj(p2, p3,p4) + hoo.gradient_wrt_rk(p1, p2, p3) + hooh.gradient_wrt_rk(p1, p2, p3, p4)
    p4_grad = ho.gradient_wrt_rj(p3, p4) + hoo.gradient_wrt_rk(p2, p3, p4) + hh.gradient_wrt_rj(p1, p4) + hooh.gradient_wrt_rl(p1, p2, p3, p4)
    ...
    potential_current = ho.potential(p1, p2) + oo.potential(p2, p3) + ho.potential(p3, p4) + hoo.potential(p1, p2, p3) + hoo.potential(p2, p3, p4) + hh.potential(p1, p4) + hooh.potential(p1, p2, p3, p4)
