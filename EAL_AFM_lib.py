...
def MDR_GenMaxwell_noVDW(G, tau, R, dt, simultime, y_dot, y_t_initial, k_m1, fo1, printstep=1, Ndy=1000, Ge=0.0,
                         dmax=10.0e-9, Q1=100, Q2=200, Q3=300):
    ...
    xc_n = np.zeros(
        (len(y_n), len(tau)))  # position of the dashpot of each SLS dependent on time as function of position and tau
    ...
    while t < simultime:
        ...
        probe, z1, z2, z3, v1, v2, v3, z1_old, z2_old, z3_old = numba_verlet_FS(y_t, Q1, Q2, Q3, k_m1, k_m2, k_m3, mass,
                                                                                t, z1, z2, z3, v1, v2, v3, z1_old,
                                                                                z2_old, z3_old, F, dt, fo1, fo2, fo3)
