...
# p2 = np.array([0.0, 0, 0])
# p3 = np.array([1.0, 0, 0])
# theta_range = np.arange(0, 10 * np.pi + 0.01, 0.01)
...
#     deriv1.append(np.sqrt(np.sum(HOO.gradient_wrt_ri(p1, p2, p3)**2)))
#     deriv2.append(np.sqrt(np.sum(HOO.gradient_wrt_rj(p1, p2, p3)**2)))
#     deriv3.append(np.sqrt(np.sum(HOO.gradient_wrt_rk(p1, p2, p3)**2)))
# # plt.plot(angle, potential)
# plt.plot(angle, deriv1, label='d1')
# plt.plot(angle, deriv2, label='d2')
# plt.plot(angle, deriv3, label='d3')
# plt.legend()
# plt.show()
# quit()
